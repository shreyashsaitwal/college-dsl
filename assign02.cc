...
class StrOps {
    public:
        ...
        static string rmChar(char ch, string str) {
            string res = "";
            for (char c : str) {
                if (c != ch) {
                    res = res + c;
        ...
        static string replaceSubstr(string str, string target, string rep) {
            int pos[2] = {-1, -1};
            int idx = 0;
    ...
    while(true) {
        ...
        switch(opr) {
            case 1: {
                ...
                cout << "-- Enter char: ";
                cin >> ch;
                cout << ">> Given char occures at these indices: " << StrOps::occurance(ch, str) << endl;
            }
            break;
            ...
            case 3: {
                ...
                cout << "-- Enter char: ";
                cin >> ch;
                cout << ">> New string: " << StrOps::rmChar(ch, str) << endl;
            }
            break;
            ...
            case 4: {
                ...
                cin >> rep;
                cout << ">> New string: " << StrOps::replaceSubstr(str, target, rep) << endl;
            }
            break;
            ...
            case 5: {
                ...
                cout << "-- Enter string: ";
                cin >> str;
                cout << ">> Is palindrome: " << StrOps::isPalindrome(str) << endl;
            }
            break;
